...
from ultralytics.data.utils import check_cls_dataset,check_det_dual_dataset
from ultralytics.nn.autobackend import AutoBackend
from ultralytics.nn.dual_autobackend import DualAutoBackend
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            if str(self.args.data).split(".")[-1] in {"yaml", "yml"}:
                self.data = check_det_dual_dataset(self.args.data)
