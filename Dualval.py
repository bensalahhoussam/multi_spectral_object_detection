...
from ultralytics.data import build_dataloader, build_yolo_dataset, build_dualyolo_dataset,converter
from ultralytics.engine.validator import BaseValidator
from ultralytics.engine.dual_validator import  BaseDualValidator
...
class DetectionDualValidator(BaseDualValidator):
    """
    ...
    def preprocess(self, batch):
        ...
        batch["ir_img"] = batch["ir_img"].to(self.device, non_blocking=True)
    ...
    def get_dataloader(self, dataset_path, batch_size):
        ...
        """
        dataset = self.build_dataset(dataset_path[0],dataset_path[1], batch=batch_size, mode="val")
